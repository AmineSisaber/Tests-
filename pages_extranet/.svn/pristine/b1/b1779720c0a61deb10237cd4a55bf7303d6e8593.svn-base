<?php
    ...
    $sql="SELECT Code_demonstratrice, [Customer name] as Customer_name"
            ...
            . " OR [Code equipe detachee] IN ('". str_replace(",", "','", $cuno) . "')"
            . " OR [Code equipe detachee2] IN ('". str_replace(",", "','", $cuno) . "')"
            . " OR [Code equipe detachee3] IN ('". str_replace(",", "','", $cuno) . "')"
            . " OR [Code equipe detachee4] IN ('". str_replace(",", "','", $cuno) . "')"
            . " OR [Code equipe detachee5] IN ('". str_replace(",", "','", $cuno) . "')"
            . " OR [Code equipe detachee6] IN ('". str_replace(",", "','", $cuno) . "')"
            . " OR Code_groupe IN ('". str_replace(",", "','", $cuno) . "')"
            . " OR Code_zone IN ('". str_replace(",", "','", $cuno) . "'))"
